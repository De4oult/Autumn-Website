...
description: Добавьте первый контроллер и получите короткий JSON-привет из Autumn.
---
...
- Модуль с контроллером должен быть импортирован приложением или найден Autumn при стартовом обходе проекта.
